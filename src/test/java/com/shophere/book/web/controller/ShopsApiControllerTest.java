...
public class ShopsApiControllerTest {
...
//        assertThat(responseEntity.getBody()).isGreaterThan(0L);
        ...
        List<Shops> all = shopsRepository.findAll();
    ...
    public void postsUpdateTest() throws Exception {
        //given
        Shops savedShops = shopsRepository.save(Shops.builder()
                .title("title")
                .content("content")
                .author("author")
                .build());

        Long updateId = savedShops.getId();
        String expectedTitle = "title2";
        String expectedContent = "content2";

        ShopsUpdateRequestDto requestDto = ShopsUpdateRequestDto.builder()
                .title(expectedTitle)
                .content(expectedContent)
                .build();

        String url = "http://localhost:" + port + "/api/v1/posts/" + updateId;
        HttpEntity<ShopsUpdateRequestDto> requestEntity = new HttpEntity<>(requestDto);
